...
<?php
                  ...
                  $query = "SELECT * FROM `all_products` WHERE sale = 0 LIMIT 7,6";
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    ...
    <li class="page-item active"><a class="page-link" href="shop-page-3.php">3</a></li>
    <li class="page-item"><a class="page-link" href="shop-page-4.php">4</a></li>
    <li class="page-item"><a class="page-link" href="shop-page-4.php">Next</a></li>
  </ul>
</nav>
</div>

...
<H4><strong>SHOP/ CATEGORIES/ BIRTHSTONES</strong></H4>

  <div class="gallery" style="padding-left: 50px; padding-bottom: 50px">
  <div class="row">

  <?php
    $query = "SELECT * FROM `all_products` WHERE category_id = 5 AND sale = 0";
  ...
  ?>
     ...
     <?php
              ...
              $query = "SELECT * FROM `all_products` WHERE category_id = 5 AND sale = 1";
              $result = mysqli_query($dbconnection,$query);

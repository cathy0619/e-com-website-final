...
<H4><strong>SHOP/ CATEGORIES/ GIFTS FOR HER</strong></H4>
  ...
  <?php
    ...
    $query = "SELECT * FROM `all_products` WHERE category_id = 2 AND sale = 0";
  ...
  ?>
   <?php
              ...
              $query = "SELECT * FROM `all_products` WHERE category_id = 2 AND sale = 1";
              $result = mysqli_query($dbconnection,$query);
